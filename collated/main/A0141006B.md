...
<AnchorPane fx:id="helpWindow" maxHeight="-Infinity" maxWidth="-Infinity" minHeight="-Infinity" minWidth="-Infinity" xmlns="http://javafx.com/javafx/8.0.65" xmlns:fx="http://javafx.com/fxml/1" fx:controller="seedu.cmdo.ui.HelpWindow" />
```
...
<HBox id="cardPane" fx:id="cardPane" accessibleRole="LIST_ITEM" styleClass="list-view-card-pane" xmlns="http://javafx.com/javafx/8.0.65" xmlns:fx="http://javafx.com/fxml/1">
    <children>
                  ...
                  <VBox fillWidth="false">
                     <children>
                        <HBox VBox.vgrow="SOMETIMES">
                           <children>
                              <Region minWidth="20.0" prefWidth="20.0" HBox.hgrow="ALWAYS" />
                              <Text strokeType="OUTSIDE" strokeWidth="0.0" text="Start " underline="true" HBox.hgrow="NEVER">
                                 <font>
                                    <Font name="Helvetica Neue UltraLight" size="10.0" />
                                 </font>
                              </Text>
                              <Label fx:id="sd" alignment="CENTER" minWidth="85.0" prefWidth="85.0" text="10/19/2016" />
                              <Label fx:id="st" alignment="CENTER" minWidth="45.0" prefWidth="45.0" text="2359" />
                              <Region minWidth="40.0" prefWidth="40.0" HBox.hgrow="ALWAYS" />
                        ...
                        <HBox>
                           <children>
                              <Region minWidth="20.0" prefWidth="20.0" HBox.hgrow="ALWAYS" />
                              <Text strokeType="OUTSIDE" strokeWidth="0.0" text="End " underline="true" HBox.hgrow="NEVER">
                                 <font>
                                    <Font name="Helvetica Neue UltraLight" size="10.0" />
                                 </font>
                              </Text>
                                    <Label fx:id="dbd" alignment="CENTER" minWidth="85.0" prefWidth="85.0" styleClass="cell_small_label" text="10/19/2016" />
                                    <Label fx:id="dbt" alignment="CENTER" minWidth="45.0" prefWidth="45.0" styleClass="cell_small_label" text="2359" />
                              <Region minWidth="40.0" prefWidth="40.0" HBox.hgrow="ALWAYS" />
                              <Text strokeType="OUTSIDE" strokeWidth="0.0" text="Priority: ">
                                 <font>
                                    ...
                                    <Label fx:id="priority" alignment="CENTER" prefWidth="55.0" styleClass="cell_small_label" text="medium" wrapText="true" HBox.hgrow="ALWAYS" />
                           </children>
                           <VBox.margin>
                              <Insets bottom="10.0" />
                           </VBox.margin>
      ...
      <Rectangle fx:id="status" arcHeight="5.0" arcWidth="5.0" fill="WHITE" height="80.0" stroke="BLACK" strokeType="INSIDE" width="80.0" HBox.hgrow="ALWAYS">
         <HBox.margin>
